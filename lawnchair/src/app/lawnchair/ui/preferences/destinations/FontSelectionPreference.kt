...
fun FontSelection(
    ...
    val items by produceState(initialValue = emptyList<FontCache.Family>()) {
        ...
        interVariants["100"] = FontCache.ResourceFont(context, R.font.inter_thin_style, "Inter v4.0 Thin")
        interVariants["100italic"] = FontCache.ResourceFont(context, R.font.inter_thin_italic_style, "Inter v4.0 Thin Italic")
        interVariants["200"] = FontCache.ResourceFont(context, R.font.inter_extra_light_style, "Inter v4.0 Extra Light")
        interVariants["200italic"] = FontCache.ResourceFont(context, R.font.inter_extra_light_italic_style, "Inter v4.0 Extra Light Italic")
        interVariants["300"] = FontCache.ResourceFont(context, R.font.inter_light_style, "Inter v4.0 Light")
        interVariants["300italic"] = FontCache.ResourceFont(context, R.font.inter_light_italic_style, "Inter v4.0 Light Italic")
        interVariants["regular"] = FontCache.ResourceFont(context, R.font.inter_regular_style, "Inter v4.0 Regular")
        interVariants["italic"] = FontCache.ResourceFont(context, R.font.inter_italic_style, "Inter v4.0 Italic")
        interVariants["500"] = FontCache.ResourceFont(context, R.font.inter_medium_style, "Inter v4.0 Medium")
        interVariants["500italic"] = FontCache.ResourceFont(context, R.font.inter_medium_italic_style, "Inter v4.0 Medium Italic")
        interVariants["600"] = FontCache.ResourceFont(context, R.font.inter_semi_bold_style, "Inter v4.0 Semi Bold")
        interVariants["600italic"] = FontCache.ResourceFont(context, R.font.inter_semi_bold_italic_style, "Inter v4.0 Semi Bold Italic")
        interVariants["700"] = FontCache.ResourceFont(context, R.font.inter_bold_style, "Inter v4.0 Bold")
        interVariants["700italic"] = FontCache.ResourceFont(context, R.font.inter_bold_italic_style, "Inter v4.0 Bold Italic")
        interVariants["800"] = FontCache.ResourceFont(context, R.font.inter_extra_bold_style, "Inter v4.0 Extra Bold")
        interVariants["800italic"] = FontCache.ResourceFont(context, R.font.inter_extra_bold_italic_style, "Inter v4.0 Extra Bold Italic")
        interVariants["900"] = FontCache.ResourceFont(context, R.font.inter_black_style, "Inter v4.0 Black")
        interVariants["900italic"] = FontCache.ResourceFont(context, R.font.inter_black_italic_style, "Inter v4.0 Black Italic")
