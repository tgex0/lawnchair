...
fun FontSelection(
    ...
    val items by produceState(initialValue = emptyList<FontCache.Family>()) {
        ...
        interVariants["100"] = FontCache.ResourceFont(context, R.font.inter_thin, "Inter v4.0 " + R.string.font_weight_thin)
        interVariants["100italic"] = FontCache.ResourceFont(context, R.font.inter_thin_italic, "Inter v4.0 " + R.string.font_weight_thin + " " + R.string.font_variant_italic)
        interVariants["200"] = FontCache.ResourceFont(context, R.font.inter_extra_light, "Inter v4.0 " + R.string.font_weight_extra_light)
        interVariants["200italic"] = FontCache.ResourceFont(context, R.font.inter_extra_light_italic, "Inter v4.0 " + R.string.font_weight_extra_light + " " + R.string.font_variant_italic)
        interVariants["300"] = FontCache.ResourceFont(context, R.font.inter_light, "Inter v4.0 " + R.string.font_weight_light)
        interVariants["300italic"] = FontCache.ResourceFont(context, R.font.inter_light_italic, "Inter v4.0 " + R.string.font_weight_light + " " + R.string.font_variant_italic)
        interVariants["regular"] = FontCache.ResourceFont(context, R.font.inter_regular, "Inter v4.0 " + R.string.font_weight_regular)
        interVariants["italic"] = FontCache.ResourceFont(context, R.font.inter_italic, "Inter v4.0 " + R.string.font_weight_regular + " " + R.string.font_variant_italic)
        interVariants["500"] = FontCache.ResourceFont(context, R.font.inter_medium, "Inter v4.0 " + R.string.font_weight_medium)
        interVariants["500italic"] = FontCache.ResourceFont(context, R.font.inter_medium_italic, "Inter v4.0 " + R.string.font_weight_medium + " " + R.string.font_variant_italic)
        interVariants["600"] = FontCache.ResourceFont(context, R.font.inter_semi_bold, "Inter v4.0 " + R.string.font_weight_semi_bold)
        interVariants["600italic"] = FontCache.ResourceFont(context, R.font.inter_semi_bold_italic, "Inter v4.0 " + R.string.font_weight_semi_bold + " " + R.string.font_variant_italic)
        interVariants["700"] = FontCache.ResourceFont(context, R.font.inter_bold, "Inter v4.0 " + R.string.font_weight_bold)
        interVariants["700italic"] = FontCache.ResourceFont(context, R.font.inter_bold_italic, "Inter v4.0 " + R.string.font_weight_bold + " " + R.string.font_variant_italic)
        interVariants["800"] = FontCache.ResourceFont(context, R.font.inter_extra_bold, "Inter v4.0 " + R.string.font_weight_extra_bold)
        interVariants["800italic"] = FontCache.ResourceFont(context, R.font.inter_extra_bold_italic, "Inter v4.0 " + R.string.font_weight_extra_bold + " " + R.string.font_variant_italic)
        interVariants["900"] = FontCache.ResourceFont(context, R.font.inter_black, "Inter v4.0 " + R.string.font_weight_extra_black)
        interVariants["900italic"] = FontCache.ResourceFont(context, R.font.inter_black_italic, "Inter v4.0 " + R.string.font_weight_extra_black + " " + R.string.font_variant_italic)
