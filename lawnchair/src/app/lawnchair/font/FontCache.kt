...
class FontCache private constructor(private val context: Context) {
    ...
    val uiRegular = ResourceFont(context, R.font.inter_regular, "Inter v4 Regular")
    val uiMedium = ResourceFont(context, R.font.inter_medium, "Inter v4 Medium")
    val uiText = ResourceFont(context, R.font.inter_regular, "Inter v4 Regular")
    val uiTextMedium = ResourceFont(context, R.font.inter_medium, "Inter v4 Medium")
