...
class FontCache private constructor(private val context: Context) {
    ...
    val uiRegular = ResourceFont(context, R.font.inter_regular_style, "Inter v4.0 Regular")
    val uiMedium = ResourceFont(context, R.font.inter_medium_style, "Inter v4.0 Medium")
    val uiText = ResourceFont(context, R.font.inter_regular_style, "Inter v4.0 Regular")
    val uiTextMedium = ResourceFont(context, R.font.inter_medium_style, "Inter v4.0 Medium")
